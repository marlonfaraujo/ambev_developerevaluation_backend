...
public class UsersController : BaseController
{
    ...
    /// <summary>
    /// Creates a new user. Note: I removed authentication validation from this endpoint to make testing easier, especially when the database has just been restored.
    /// </summary>
